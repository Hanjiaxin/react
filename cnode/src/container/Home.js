        ...
        return (
            <div>
                <div className='title'>
                    ...
                    <Link className='topic_tab' to={url +'/recruit'}>招聘</Link>
                ...
                <div>
                    <Switch>
                        ...
                        <Route exact path='/home/recruit' render={() => <Redirect from='/home/recruit' to='/home/recruit/1'/>}/>
                        <Route path={url +'/recruit/:id'}  component={Recruit}/>
